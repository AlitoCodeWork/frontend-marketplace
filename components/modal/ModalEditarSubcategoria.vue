  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" @click="$emit('close')">
    <div class="bg-white rounded-lg w-full max-w-md" @click.stop>
      ...
      <div class="p-5 border-b border-gray-200 flex justify-between items-center">
        <h3 class="text-lg font-semibold text-gray-800">Actualizar Subcategoría</h3>
      ...
      <div class="p-5">
        <div class="space-y-4">
          ...
          <div>
            ...
            >
              <option value="" disabled>Escoja la categoría</option>
      ...
      <div class="flex justify-end gap-2 p-5 border-t border-gray-200">
        ...
        >
          {{ cargando ? 'Actualizando...' : 'Actualizar subcategoría' }}
        </button>
      </div>
    </div>
  </div>
    ...
    subcategoria: {
      handler(newValue) {
        if (newValue) {
          ...
          this.form.nombre = newValue.nombre
          this.form.categoria_id = newValue.categoria_id
        }
      },
      immediate: true
    }
